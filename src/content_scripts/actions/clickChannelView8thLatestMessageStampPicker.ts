...
const clickChannelView8thLatestMessageStampPicker = () => {
  const messageSelector = selectors.channelView8thLatestMessage();
...
export default clickChannelView8thLatestMessageStampPicker;

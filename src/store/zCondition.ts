...
const zCondition = z.union([
  ...
  z.literal('isFocusNavigationBarChannelsChannelFilterInput'),
  z.literal('notIsFocusNavigationBarChannelsChannelFilterInput'),
  z.literal('isFocusNavigationBarUsersUserFilterInput'),
  z.literal('notIsFocusNavigationBarUsersUserFilterInput'),

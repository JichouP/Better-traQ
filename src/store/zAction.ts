...
const zAction = z.union([
  ...
  z.literal('cVSelectedMsg1stStamp'),
  z.literal('cVSelectedMsg2ndStamp'),
  z.literal('cVSelectedMsg3rdStamp'),
  z.literal('cVSelectedMsg4thStamp'),
  z.literal('cVSelectedMsg5thStamp'),
  z.literal('cVSelectedMsg6thStamp'),
  z.literal('cVSelectedMsg7thStamp'),
  z.literal('cVSelectedMsg8thStamp'),
  z.literal('cVSelectedMsg9thStamp'),
  z.literal('cVSelectedMsg10thStamp'),
